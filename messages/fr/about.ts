const about = {
  ...
  message: "Un alpage historique au cœur des Alpes depuis 1264",
  attributes: [
    {
      title: "Héritage",
  ...
  team: {
    ...
    items: [
      {
        name: "Les Gardiens",
        role: "Gardiens du refuge",
        image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e",
        description:
          "Perpétuant la tradition d'accueil des alpages, nos gardiens vous font découvrir l'authenticité de la vie en montagne.",
      },
      {
        name: "La Cuisine de Montagne",
        role: "Restauration traditionnelle",
