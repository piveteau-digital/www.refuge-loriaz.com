...
//                 {searchParams.get("accomodationName")}
//               </p>
//               <p>
//                 <span className="font-medium">Check-in:</span>{" "}
//                 {new Date(
//                   decodeURIComponent(searchParams.get("startDate") || "").split("00") as unknown as string
//                 ).toDateString()}
//               </p>
//               <p>
//                 <span className="font-medium">Check-out:</span>{" "}
//                 {new Date(
//                   decodeURIComponent(searchParams.get("endDate") || "").split("00") as unknown as string
//                 ).toDateString()}
//               </p>
//               <p>
//                 <span className="font-medium">Total Price:</span> €
//                 {(Number(searchParams.get("price")) / 100).toFixed(2)}
//               </p>
//               <p>
